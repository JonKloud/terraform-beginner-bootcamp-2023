...
class Home
  ...
  # It's used as an ORM. It has a module within
  ...
  # we will make sure there is an incremental version in the controller.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  # return a hardcoded access code
  def x_access_code
  ...
  def find_user_by_bearer_token
    ...
    # if we cant find it (or doesn't match), then return an error
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # a begin/resource is a try/catch, if an error occures, rescue it
    begin
    ...
    # to make it easer to work with the code
    name = payload["name"]
    ...
    # to see our debug what we have inputed into this endpoint
    puts "name #{name}"
    ...
    # ensure our validations checks pass otherwise
    # return the errors
    unless home.valid?
      # return the errors messages bacj as json
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid for the home match the on in our database
...
# This is waht will run the server
